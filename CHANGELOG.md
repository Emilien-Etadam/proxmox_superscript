...
- Options menu **8** / **9** : raccourcis vers `update-lxcs.sh` et `clean-lxcs.sh` (community-scripts/ProxmoxVE), avec confirmation et contrôle d'URL avant exécution distante.
